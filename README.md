...
<p align="center">
  <a href="https://samuelmataraso.com">
    <img src="https://i.imgur.com/zeXD6nv.jpg" alt="Logo">
  </a>

  <h3 align="center">Template Frintezza Advanced</h3>
</p>
...
Este projeto visa a criação de um template usando o padrão de Arquitetura Page/Component que possa ser utilizado no momento de criação de projetos utilizando React Native, visto que o processo de instalação e configuração das libs no início de um projeto podem gerar certa complexidade e muitas vezes até erros que atrasam o processo, atrapalhando assim o fluxo de desenvolvimento.

Esse template foi baseado no [Template Rocketseat Advanced](https://github.com/Rocketseat/react-native-template-rocketseat-advanced) da Rocketseat.
...
```sh
react-native init AwesomeExample --template frintezza-advanced
```
...
- **src** - Diretório contendo todos os arquivos da aplicação, é criado um diretório `src` para que o código da aplicação possa ser isolado em um diretório e facilmente portado para outros projetos, se necessário;
  ...
  - **components** - Diretório para guardar todo tipo de component criado na sua aplicação.
